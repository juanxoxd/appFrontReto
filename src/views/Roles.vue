      ...
      <tbody>
        <tr v-for="(item, index) in categorias" :key="index">
          ...
          <td style="color:black;">
            ...
            <b-button class="btn-warning mx-2 " type="submit" @click="editarCategoria(item.id)">Editar</b-button>
          </td>
        </tr>
      </tbody>
    </table>
...
export default {
  ...
  methods: {
    ...
    paginacion(pagina) {
      ...
      this.axios.get(`/nota?limite=${this.limite}&desde=${desde}`)
        .then(res => {
